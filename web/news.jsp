                        ...
                        <div class="content-create-news">
                            <div class="form-news">
                                ...
                                <div class="news-group">
                                    ...
                                    <input type="text" id="news-image" placeholder="đường dẫn ảnh" />
                                </div>
                                <div class="news-group">
                                    <label for="news-title">Tiêu đề</label>
                                    <input type="text" id="news-title" placeholder="Nhập tiêu đề" />
                                </div>
                                 <div class="news-group">
                                    <label for="news-link">Link chi tiết</label>
                                    <input type="text" id="news-link" placeholder="Link bài viết" />
                                </div>
                                <div class="news-group">
                                    <label for="news-desc">Mô tả</label>
                                    <textarea type="text" id="news-desc" cols="30" rows="6"></textarea>
                                </div>
                                <div id="Create-new1">
